...
puts 'Creating users...'
asma = User.create!(first_name: "Asma", last_name: "Laaribi", email: "asma@email.com", password: "secret1", skill_level: "4", address: "5333 Avenue Casgrain, Montreal, QC H2T 1X3")
